 ...
 * 예: "오후 2:00", "오전 9:30"
 */
export function formatKoreanTime(time: Date | string | undefined): string {
  if (!time) return '';
 ...
 */
export function parseDateToPickerState(date: Date) {
 ...
 */
export function createDateFromPickerState(
  ampm: 'AM' | 'PM',
  hour: string,
  minute: string
): Date {
