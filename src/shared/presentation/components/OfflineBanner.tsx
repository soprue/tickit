...
export function OfflineBanner() {
  ...
  return (
    <div className="pointer-events-none fixed right-0 bottom-0 left-0 z-[2400]">
      <div className="flex min-h-11 items-center justify-start gap-2 border-t border-red-500/25 bg-red-50/95 px-5 py-3 text-left shadow-[0_-8px_24px_rgba(0,0,0,0.08)] backdrop-blur-md dark:border-red-400/25 dark:bg-red-950/90">
