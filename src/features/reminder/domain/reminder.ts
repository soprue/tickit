    ...
    items: [
      {
        id: 1,
        text: '약 먹기',
        time: new Date(new Date(today).setHours(14, 0, 0, 0)).toISOString(),
        isAllDay: false,
        notified: true,
        done: true,
      },
      {
        id: 2,
        text: '알고리즘 문제 풀기',
        time: new Date(new Date(today).setHours(16, 0, 0, 0)).toISOString(),
        isAllDay: false,
        notified: false,
        done: false,
      },
      {
        id: 3,
        text: '산책하기',
        time: new Date(new Date(today).setHours(23, 0, 0, 0)).toISOString(),
        isAllDay: false,
        notified: false,
        done: true,
      },
